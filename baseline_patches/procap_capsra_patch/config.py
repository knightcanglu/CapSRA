...
def parse_opt():
    ...
    parser.add_argument("--DATA", type=str, default="/home/icdm/yhy/Pro-Cap/Data")
    parser.add_argument("--CAPTION_PATH", type=str, default="/home/icdm/yhy/Pro-Cap/Ask-Captions/Captions/mem")
    ...
    parser.add_argument("--ASK_CAP", type=str, default="race,gender,country,animal,valid_disable,religion")
    parser.add_argument("--LONG", type=str, default="Longer-")
    ...
    parser.add_argument("--train_neighbor_path", type=str, required=True)
    parser.add_argument("--train_feature_path", type=str, required=True)
    parser.add_argument("--test_neighbor_path", type=str, required=True)
    parser.add_argument("--test_feature_path", type=str, required=True)
    parser.add_argument("--GAT_LR", type=float, default=3e-3)
    parser.add_argument("--CLS_LR", type=float, default=1e-3)
    parser.add_argument("--ALPHA", type=float, default=0.8)
    parser.add_argument("--IB_HIDDEN_DIM", type=int, default=128)
    parser.add_argument("--IB_BETA", type=float, default=1e-3)
    parser.add_argument("--IB_DETERMINISTIC", action="store_true")
